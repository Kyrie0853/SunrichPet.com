  ...
  return (
    <div>
      ...
      <Link href="/studio/dashboard/products/new"
        ...
        <div>
          <p className="text-[16px] font-bold">添加新商品</p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-8">
        {[{ label: "总商品数", value: productCount || 0, color: "bg-[#e8f5ef] text-[#1a7f5a]" }, { label: "可发货", value: available, color: "bg-emerald-50 text-emerald-600" }, { label: "预售中", value: presale, color: "bg-orange-50 text-orange-600" }, { label: "总订单", value: orderCount || 0, color: "bg-blue-50 text-blue-600" }].map(stat => (
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {/* 快捷操作 */}
        <div>
          <h2 className="text-[15px] font-semibold text-[#1f2937] mb-3">快捷操作</h2>
          <div className="space-y-2">
            <Link href="/studio/dashboard/products/new" className="block rounded-xl bg-white border border-[#f3f4f6] p-4 hover:border-[#1a7f5a]/30 transition-colors">
              <p className="text-[14px] font-semibold text-[#1f2937]">+ 添加新商品</p>
            ...
            <Link href="/studio/dashboard/orders" className="block rounded-xl bg-white border border-[#f3f4f6] p-4 hover:border-[#1a7f5a]/30 transition-colors">
              <p className="text-[14px] font-semibold text-[#1f2937]">📦 订单管理</p>
              <p className="text-[12px] text-[#6b7280] mt-1">查看订单，确认收款，发货</p>
            </Link>
            <Link href="/studio/dashboard/products" className="block rounded-xl bg-white border border-[#f3f4f6] p-4 hover:border-[#1a7f5a]/30 transition-colors">
              <p className="text-[14px] font-semibold text-[#1f2937]">🦎 商品管理</p>
              <p className="text-[12px] text-[#6b7280] mt-1">查看和管理所有在售/预售/已售商品</p>
            </Link>
            <Link href="/studio/dashboard/settings" className="block rounded-xl bg-white border border-[#f3f4f6] p-4 hover:border-[#1a7f5a]/30 transition-colors">
              <p className="text-[14px] font-semibold text-[#1f2937]">💚 收款码设置</p>
              <p className="text-[12px] text-[#6b7280] mt-1">上传微信收款码，买家下单时显示</p>
            </Link>
            {isSuperAdmin && (
              <Link href="/admin/users" className="block rounded-xl bg-white border border-[#f3f4f6] p-4 hover:border-[#1a7f5a]/30 transition-colors">
                <p className="text-[14px] font-semibold text-[#1f2937]">👥 用户管理（超管）</p>
                <p className="text-[12px] text-[#6b7280] mt-1">管理管理员账号，设置角色权限</p>
              </Link>
            )}
          </div>
        </div>
