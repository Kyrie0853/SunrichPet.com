    ...
    <div className="mx-auto max-w-5xl px-3 md:px-4">
      ...
      <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/blog"
            className="inline-flex items-center gap-1.5 rounded-full border border-[#d1d5db] px-4 py-2 text-[13px] text-[#6b7280] hover:text-[#1f2937] hover:border-[#9ca3af] transition-colors"
          >
            繁育笔记
          </Link>
        </div>
